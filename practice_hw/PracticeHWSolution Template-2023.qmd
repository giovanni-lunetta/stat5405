---
title: "Stat 5405 Practice HW Solution Template"
...
**Answer**: I have read how to use Quarto withtin RStudio to write a report including R code.
...
Let $X_i,~i=1,\ldots,n$ be a random sample from a population of interest. Suppose $n=4$. Let $X_1=2, X_2=3, X_3=2, X_4=5$. Then, the sample mean is $$
 \overline{X} = \frac{1}{4}\sum_{i=1}^4 X_i = (2+3+2+5)/4 = 
$$

**Answer**: The sample mean $\overline{X}$ is ------- .
